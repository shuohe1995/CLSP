...
from torchvision.transforms import Grayscale, RandomCrop, RandomHorizontalFlip, RandomResizedCrop, ToPILImage
...
def _transform(n_px):
    return Compose([
        ...
        #RandomResizedCrop(n_px, interpolation=InterpolationMode.BICUBIC),
